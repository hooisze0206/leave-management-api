...
header("Content-Type: application/json; charset=UTF-8");
    class leaveGateway{
        ...
        // all holiday and leave
        public function get_all_leave_holiday_user($user){
            $cmd = "CALL `sp_get_holiday_and_leave`(:user)";       
        ...
        // all requested leave
        public function get_all_requested_leave($data){
            $cmd = "CALL `sp_get_all_requested_leave`(:user, :role)";       
        ...
        // all requested leave
        public function get_all_pending_requested_leave($status,$data){
            $cmd = "CALL `sp_get_all_pending_requested_leave`(:status,:user)";       
        ...
        public function get_all_leave_type(){
            $cmd =  "SELECT * FROM utils_leave_type";       
